...
async function main() {
  ...
  try {
    ...
    const pasos: [string, () => Promise<{ count: number }>][] = [
      ...
      ["CalificacionVisitaFoto", () => prisma.calificacionVisitaFoto.deleteMany()],
      ["CalificacionVisita", () => prisma.calificacionVisita.deleteMany()],
      ["VisitaMedia", () => prisma.visitaMedia.deleteMany()],
      ["VisitaPersonalTarea", () => prisma.visitaPersonalTarea.deleteMany()],
    ...
    if (!EJECUTAR) {
      ...
      const cuentas: Record<string, number> = {
        ...
        CalificacionVisitaFoto: await prisma.calificacionVisitaFoto.count(),
        CalificacionVisita: await prisma.calificacionVisita.count(),
        VisitaMedia: await prisma.visitaMedia.count(),
        VisitaPersonalTarea: await prisma.visitaPersonalTarea.count(),
